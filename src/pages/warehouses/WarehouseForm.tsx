  ...
  return (
    <Layout>
       <div className="max-w-xl mx-auto">
        <button onClick={() => navigate('/warehouses')} className="flex items-center text-slate-500 mb-6 gap-2"><ArrowLeft size={16}/> Kembali</button>
        <div className="bg-white rounded-xl shadow-sm border border-slate-200 p-6">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
               ...
               <input type="number" className="w-full border border-slate-300 rounded-lg px-4 py-2" value={formData.capacity_limit} onChange={e => setFormData({...formData, capacity_limit: Number(e.target.value)})} />
            </div>
